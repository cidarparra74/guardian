...
function cargar_adicionar(){
	document.adicionar.notario.focus();
}

function cargar_modificar(){
	document.modificar.notario.focus();
}
...
function verificar_adicion(){
	var mensaje= "Debe escribir un notario";
	var mensaje_igual= "Ya existe un notario con este nombre\nEscriba otro notario";
	var antes= document.all["notario"];
