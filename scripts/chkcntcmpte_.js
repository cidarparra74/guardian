...
function validar(form){		
	...
	if (document.getElementById('centrocosto').value =='*')
	{	
	...
	//alert(document.getElementById('nitemsingr').value);
	for (var i = 0; i < document.getElementById('nitemsingr').value; i++){
		idcta = 'idcta'+i.toString();
		cod = 'cod'+i.toString();		
		deb = 'deb'+i.toString();
		hab = 'hab'+i.toString();
		...
		//if (document.getElementById(idcta).value == '' && document.getElementById(idcta).value == 0){
		//}
		if (document.getElementById(cod).value != '' && document.getElementById(cod).value != 0){
			cnt++;
