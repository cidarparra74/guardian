...
document.write("<td><img src=\""+loc+"menu__top.png\" alt=\"\" width=\"125\" height=\"30\"></td>");
tr(false);

writeButton(loc+"","../../../../usuarios/comun.php?carpeta_entrar=archivoage","menu__b7",125,30,"Archivo agencia","contenido",0);
...
writeButton(loc+"","../../../../usuarios/comun.php?carpeta_entrar=ver_informe_legal&filtro=ninguno","menu__b4",125,30,"Reportes","contenido",0);
writeButton(loc+"","../../../../usuarios/comun.php?carpeta_entrar=excepciones","menu__b6",125,30,"Excepciones","contenido",0);

tr(true);
document.write("<td><img src=\""+loc+"menu__bottom.png\" alt=\"\" width=\"125\" height=\"30\"></td>");
