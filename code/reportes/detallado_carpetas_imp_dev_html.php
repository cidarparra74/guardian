...
convert(varchar,c.creacion_carpeta,103) as fecha, c.operacion, c.nrocaso as cuenta, us.nombres as solicitado, u.nombres as entregado, corr_dev as devolucion
FROM (propietarios p 
...
$smarty->display('reportes/detallado_carpetas_imp_dev_html.html');
die();
?>