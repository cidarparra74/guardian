...
inner join opciones op on op.id_perfil_cat = us.id_perfil
	...
	$sql= "SELECT id_usuario, nombres FROM usuarios INNER JOIN oficinas ON oficinas.id_oficina=usuarios.id_oficina 
		WHERE id_usuario!='$id_us_actual' AND oficinas.id_almacen='$id_almacen' ORDER BY nombres ";
		//cambiado para bsol para que solo muestre el usuario que solicito
...
//echo "$sql";
	...
	$smarty->display('mensajes/aceptar_solicitud.html');
	die();
?>
