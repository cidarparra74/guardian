<?php
	...
	*/
	...
	//lista de usuarios de autoriza AND id_perfil='3'
	...
	$sql= "SELECT * FROM movimientos_carpetas WHERE id_carpeta='$id' AND flujo='0' AND id_estado='2' ";
	//echo "$sql <br>";
	$result= consulta($sql);
	$resultado= $result->fetchRow(DB_FETCHMODE_ASSOC);
	...
	$smarty->display('mensajes/eliminar_rechazada.html');
	die();
?>
