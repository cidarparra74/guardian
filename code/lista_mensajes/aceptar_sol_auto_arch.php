<?php
	...
	$sql= "SELECT m.id_carpeta, m.auto_arch, m.auto_arch_plazo, m.id_us_corriente, m.id_us_autoriza, m.obs_1, m.obs_3, u.nombres  FROM movimientos_carpetas m, usuarios u WHERE id_movimiento_carpeta='$id_movimiento' AND m.flujo='0' AND m.id_us_corriente=u.id_usuario ";
	$result= consulta($sql);
	...
	$smarty->display('lista_mensajes/aceptar_sol_auto_arch.html');
	die();
?>
