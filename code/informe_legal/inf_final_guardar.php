<?php
	...
	$montoprestamo	= $_REQUEST["montoprestamo"];
...
//fecha actual
//2019-07-22 adicionando fecha actual por Percy
$fecha_actual= date("Y-m-d H:i:s");
$fecha_actual= "CONVERT(DATETIME,'$fecha_actual',102)";
//aceptando la elaboracion de i.l.
$sql= "INSERT INTO informes_legales_fechas(id_informe_legal, fecha_quitar, usr_acep, html) 
	VALUES( '$id', $fecha_actual, '$id_us_actual', 'Informe Final') ";
ejecutar($sql);
...
if(enviaCorreo()){
	...
	if($destinatario!=''){
		...
		Fecha Seguro del: $inf_fecha_ini&nbsp;Al:&nbsp;$inf_fecha_fin&nbsp;&nbsp;Nota:&nbsp;$inf_nota<br />
