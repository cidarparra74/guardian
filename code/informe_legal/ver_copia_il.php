<?php
	//var 'tipo' es pasado desde informe_legal.php

	$id= $_REQUEST['id']; //es el id del informe legal guardado
	$idnew= $_REQUEST['ver_bk']; //es el id del informe legal guardado
	
	
	//recpueramo los datos del informe legal
	$sql= "SELECT il.*, tb.tipo_bien, tb.bien, pr.nombres as cliente, pr.ci
	...
	*/
	...
	$smarty->display('informe_legal/ver_copia_il.html');
	die();
