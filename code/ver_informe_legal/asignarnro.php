...
//ahora tambien llamado y usado desde instanciar_bsol.php
	$id= $_REQUEST["id"];
	$sql =  "SELECT ile.cliente, ile.ci_cliente, ile.nrocaso as cuenta, tii.identificacion, tbi.tipo_bien, ile.nrocaso ".
	...
	$smarty->display('ver_informe_legal/asignarnro.html');
	die();
