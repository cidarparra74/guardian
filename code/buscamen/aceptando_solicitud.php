...
$sql= "UPDATE movimientos_carpetas SET auto_arch=$fecha_actual, auto_arch_plazo=$fecha, 
id_us_corriente='$id_us_mandar', id_us_archivo='$id_archivo', id_estado='3', obs_3='$observacion' 
