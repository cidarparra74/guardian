<?php
	...
	//recuperando la lista de todos los usuarios diferentes al actual
	$sql= "SELECT id_usuario, nombres  FROM usuarios WHERE id_usuario!='$id_us_actual' AND id_perfil!='1' ORDER BY nombres ";
	$result= consulta($sql);
